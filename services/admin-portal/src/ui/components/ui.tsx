...
const styles: Record<string, React.CSSProperties> = {
  ...
  hTitle: { fontSize: 24, fontWeight: 950, color: 'var(--csp-text)' },
  hSub: { color: 'var(--csp-muted)', fontSize: 14, marginTop: 4, maxWidth: 880, lineHeight: 1.45 },
  panel: {
    border: '1px solid var(--csp-border)',
    borderRadius: 'var(--csp-radius-md, 8px)',
    background: 'var(--csp-surface-bg)',
    boxShadow: 'var(--csp-shadow-sm, none)',
    padding: 16,
    color: 'var(--csp-text)',
  },
  panelHead: { display: 'flex', justifyContent: 'space-between', gap: 10, marginBottom: 12, alignItems: 'flex-start' },
  panelTitle: { fontWeight: 950, fontSize: 15 },
  panelSub: { color: 'var(--csp-muted)', fontSize: 13, marginTop: 4, lineHeight: 1.35 },
  grid2: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, alignItems: 'start' },
  label: { display: 'grid', gap: 6, fontSize: 14, color: 'color-mix(in srgb, var(--csp-text) 90%, transparent)' },
  hint: { color: 'color-mix(in srgb, var(--csp-muted) 92%, transparent)', fontSize: 12, lineHeight: 1.35 },
  input: {
    padding: '10px 12px',
    borderRadius: 'var(--csp-radius-sm, 6px)',
  ...
  tabBadge: {
    ...
    fontSize: 11,
    fontWeight: 700,
    border: '1px solid var(--csp-border, rgba(255,255,255,0.12))',
    background: 'var(--csp-chip-bg, rgba(0,0,0,0.18))',
    color: 'color-mix(in srgb, var(--csp-text, rgba(230,237,243,0.85)) 88%, transparent)',
  },
  error: {
    padding: 12,
    borderRadius: 'var(--csp-radius-md, 8px)',
  ...
  kvKey: { color: 'var(--csp-muted)', fontSize: 13 },
  kvVal: { color: 'var(--csp-text)', fontSize: 13 },
}
