...
const styles: Record<string, React.CSSProperties> = {
  ...
  sub: { marginTop: 6, color: 'var(--csp-muted)', fontSize: 13, lineHeight: 1.45 },
  createBox: {
    marginTop: 14,
    padding: 14,
    borderRadius: 14,
  ...
  createSub: { marginTop: 6, color: 'var(--csp-muted)', fontSize: 12, lineHeight: 1.45 },
  ...
  rowSub: { marginTop: 4, color: 'var(--csp-muted)', fontSize: 12, fontFamily: 'ui-monospace, Menlo, Consolas, monospace' },
  muted: { color: 'var(--csp-muted)', fontSize: 13, marginTop: 12 },
  error: {
    marginTop: 12,
    padding: 12,
    borderRadius: 12,
